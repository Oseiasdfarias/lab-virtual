...
- **Cap. 3 (Resultados) e Cap. 4 (Conclusão)**: usam os arquivos em `Capitulos/` (versões com pequenas correções de texto/figura em relação às gêmeas em `elementos_textuais/`, que não são usadas).
